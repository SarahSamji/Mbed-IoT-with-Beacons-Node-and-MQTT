...
#define BROKER "192.168.1.2"                // MQTT broker URL
#define PORT 1883                           // MQTT broker port number
#define CLIENTID "board4"                    // use K64F MAC address without colons
...
#define TOPIC "board4Topic"                    // MQTT topic
